...
\caption{Equation of states of Hard Spherocylinders (left) and Hard Ellipsoids (right). Insets show
  the static structure factor and snapshots for $\phi\approx 0.50$.
