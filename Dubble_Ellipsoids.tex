...
\caption{Equation of states of Hard Spherocylinders (left) and Hard Ellipsoids (right) from Monte Carlo simulations. 
  Insets show the static structure factor and snapshots for $\phi\approx 0.50$.
