...
%In Fourier space, the structure factor becomes elongated along the direction corresponding to the short axes of the particles keeping the other two direction unchanged. As a result the structure factor is modulated in the form of a spherocylinder (SC) as shown in fig.~\ref{Fspace_smectic}(f). 
...
To build the equation of state (EOS) in Figs.~\ref{fig:sim}a and \ref{fig:sim}b we performed MC in the isobaric ensemble (NPT) where the three
dimensions of the orthorombic box were allowed to change independently in order to ease the emergence of mesophases.
