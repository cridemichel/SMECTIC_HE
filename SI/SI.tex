...
Here, we carefully investigate 
, hence we carefully investigate shape of hematite-silica particles.
In particular, it has been obtained the particle borders from a pool of
samples belonging to the two aspect ratios ($\rho_1 = 2.82, \rho_2 = 3.69$). By developing a C++ program, the coordinates of the borders have been analysed and
